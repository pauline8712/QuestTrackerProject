...
namespace HeroProject
{
    ...
    public class User
    {
        ...
        public string password; // Lowercase public field to match "this.password" and maintain serialisation
        ...
        {
            if (string.IsNullOrEmpty(password)) return (false, false, false, false);
            return (
                password.Length >= 6,
